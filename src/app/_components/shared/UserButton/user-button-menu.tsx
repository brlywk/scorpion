            ...
            >
                <div className="flex flex-col items-stretch divide-y divide-gray-300">
                    ...
                    <div className="p-2">
                        <Link
                            href="/preferences"
                            className="flex flex-row items-center gap-2 rounded-lg p-2 transition-all hover:bg-gray-100"
                        >
                            <svg
                    ...
                    <div className="p-2">
                        <button
                            onClick={() => signOut()}
                            className="flex w-full flex-row items-center gap-2 rounded-lg p-2 text-left text-red-400 transition-all hover:bg-red-400 hover:text-white"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
